...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.css" />
  ...
  <style type="text/css" media="screen">
    ...
    @foreach($slider as $key=>$value)
        ...
        {
            background: url({{ asset('uploads/slider/'.$value->image) }});
            ...
            <div class="item">
                <div class="container">
                    <div class="header-content">
                        <h1 class="header-title">{{ $value->title }}</h1>
                        <p class="header-sub-title">{{ $value->sub_title }}</p>
                    </div> <!-- /.header-content -->
                </div>
            </div>
...
<section id="pricing" class="pricing">
    <div id="w">
              ...
              <div class="row">
                <div class="col-md-10 col-md-offset-1">
                 <div class="section-header">
                    <h2 class="pricing-title">Our Menu In Affordable Pricing</h2>
              <ul id="filter-list" class="clearfix">
                     <li class="filter" data-filter="all">All</li>
        @foreach($categories as $category)
            <li class="filter" data-filter="#{{ $category->id }}">{{ $category->category }} <span class="badge">{{ $category->items->count() }}</span></li>
         @endforeach
        ...
        @foreach($item as $item)      
                 <li class="item" id="{{ $item->category_id }}">
                      <a href="#">
        ...
        <section id="bread" class="bread">
            ...
            {{ asset('frontend/images/icons/bread_color.png') }}">
            <div class="container-fluid">
                <div class="row dis-table">
                    <div class="hidden-xs col-sm-6 dis-table-cell section-bg">
  ...
  <img class="img-responsive section-icon hidden-sm hidden-xs" 
   src="{{ asset('frontend/images/icons/reserve_color.png') }}">
       ...
       <font style="color: red">
        ...
        <font style="color: red">
              {{ ($errors->has('dateandtime'))?($errors->first('dateandtime')):'' }}
         </font>                           
                                </div>
...
<div class="container">
 ...
 <form class="contact-form" method="post" action="{{ route('frontend.index') }}">
        @csrf 
         <div class="col-md-6 col-sm-6">
             <div class="form-group">
